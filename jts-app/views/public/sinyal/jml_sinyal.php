...
$(function() {
    ...
    function ses_kelurahan_id(i,k) {
        $.get('<?=site_url("web/ajax/ses_kelurahan_id")?>?ses_kecamatan_id='+i+'&ses_kelurahan_id='+k,null,function(data) {
    ...
    $('#proses').bind('click',function() {
        ...
        if(uptd_id.val() == '') {
            ...
            $('#mainform').attr('action','<?=site_url("web/filter/jml_sinyal")?>').submit();
        }        
    });
    //
    $('.row_dim').hide(); 
			...
			<div class="row-fluid">
				<div class="span12">
					...
					<div class="widget widget-heading-simple widget-body-white">
						<div class="widget-head"><h4 class="heading glyphicons list"><i></i>Resume Jumlah Data Sebaran Sinyal Seluler/Telekomunikasi Di Wilayah Kabupaten Kebumen</h4></div>
								...
								<div class="span12">
									<form name="mainform" id="mainform" class="row-fluid margin-none" action="" method="post" enctype="multipart/form-data">	
										...
										<div class="right" style="margin-top:10px">
											...
											<a href="<?=site_url('web/location/jml_sinyal')?>" class="btn btn-danger btn-icon btn-submit"><i></i> Clear</a>
										</div>
										...
										<br>
											<?php if($ses_jenis_laporan == '1'): ?>
												<div class="alert alert-success">
													<strong>Resume Jumlah Sinyal Per Kecamatan</strong>
												</div>
												<div class="table-responsive">
																...
																<tr>
																	...
																	<td class="center">
																		<?php foreach ($data['operator_id'] as $operator):
																			  $operator_nm = $this->sinyal_model->get_parameter_nm('sinyal','operator_id',$operator);
																		?>
																		<?=$operator_nm?>
																		<?php endforeach; ?>
																	</td>
													...
													<div class="span6">
														<div id="kecamatan" style="height: 1080px; "></div>
													</div>
												</div>
											<?php elseif($ses_jenis_laporan == '2'): ?>
												<div class="alert alert-success">
													<?php 
													if($ses_kecamatan_id != ''):
													$nama_kecamatan = $this->sinyal_model->get_wilayah_by_id($ses_kecamatan_id);
													?>
														<strong>Resume Jumlah Sinyal Dari Kecamatan : <?=$nama_kecamatan['wilayah_nm']?></strong>
													<?php else: ?>
														<strong>Resume Jumlah Sinyal Per Kelurahan</strong>
													<?php endif; ?>
												</div>
												<div class="table-responsive">
													<div class="span6">
													...
													<div class="span6">
														...
														<?php else: ?>
															<div id="kelurahan" style="height: 18735px; "></div>
														<?php endif; ?>
													</div>
												</div>
											<?php endif; ?>
