								...
								<div class="span12">
									<div class="table-responsive">
										<table class="table">
									            ...
									            <td width="462px">
									            	<table>		
														...
														<tr>
															...
															<td width="300px" class="column-spacing"><div class="span12"> : <?=date_now_time($main['tgl_pendataan'])?></div></td>
														</tr>
														<tr>
														...
														<tr>
															<td colspan="2" class="widget-head" style="margin:0 0 0px -15px">
																<h4 class="heading"><b>BERTEMPAT DI</b></h4>
															</td>
														</tr>
														<tr>
														...
														<tr>
															<td width="150px" class="column-spacing"><div class="span12"><b>Dukuh</b></div></td>
															<td width="300px" class="column-spacing"><div class="span12"> : <?=$main['alamat_dukuh']?></div></td>
														</tr>
														<tr>
															<td width="150px" class="column-spacing"><div class="span12"><b>Kecamatan</b></div></td>
															<td width="300px" class="column-spacing"><div class="span12"> : <?=$main['kecamatan_nm']?></div></td>
														</tr>
														<tr>
															<td width="150px" class="column-spacing"><div class="span12"><b>Desa/Kelurahan</b></div></td>
															<td width="300px" class="column-spacing"><div class="span12"> : <?=$main['desa_nm']?></div></td>
														</tr>
														<tr>
														...
														<tr>
															<td width="150px" class="column-spacing"><div class="span12"><b>Nama Lokasi</b></div></td>
															<td width="300px" class="column-spacing"><div class="span12"> : <?=$main['lokasi_nm']?></div></td>
														</tr>
														<tr>
            								...
            								<tr>
												<td colspan="2" class="widget-head" style="margin:0 0 0px -15px">
													<h4 class="heading"><b>HASIL PENELUSURAN</b></h4>
												</td>
											</tr>
											<tr>
												<td colspan="2">
										...
										<div class="right" style="margin-top:10px">
											<a href="<?=site_url('web/location/sinyal')?>" class="btn btn-secondary btn-icon"> Kembali</a>
										</div>
								</div>
							</div>
						</div>
