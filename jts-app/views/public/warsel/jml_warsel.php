...
$(function() {
    ...
    $('#proses').bind('click',function() {
        ...
        if(uptd_id.val() == '') {
            ...
            $('#mainform').attr('action','<?=site_url("web/filter/jml_warsel")?>').submit();
        }        
    });
    //
    $('.row_dim').hide(); 
								...
								<div class="span12">
									<form name="mainform" id="mainform" class="row-fluid margin-none" action="" method="post" enctype="multipart/form-data">	
										...
										<div class="right" style="margin-top:10px">
											...
											<a href="<?=site_url('web/location/jml_warsel')?>" class="btn btn-danger btn-icon btn-submit"><i></i> Clear</a>
										</div>
