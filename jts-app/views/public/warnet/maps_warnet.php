<script type="text/javascript">
	$(function() {
		...
		$('#ses_tgl_pendataan, #ses_kecamatan_id').bind('change',function() {
	        $('#form-search').attr('action','<?=site_url("web/search/maps_warnet")?>').submit();
	    });
	    $('#ses_tgl_pendataan_mobile, #ses_kecamatan_id_mobile').bind('change',function() {
	        $('#form-search_mobile').attr('action','<?=site_url("web/search/maps_warnet")?>').submit();
	    });
	});
</script>
<div id="landing_2">
			...
			<div class="row-fluid">
				<div class="span12">
					...
					<div class="widget widget-heading-simple widget-body-white">
						<div class="widget-head"><h4 class="heading glyphicons list"><i></i>Peta Sebaran Data Warnet</h4></div>
							...
							<div class="row-fluid">	
								<div class="span12">
									...
									<div class="desktop-view">
										<form name="form-search" id="form-search" method="post" action="<?=site_url('web/search/maps_warnet')?>">
											<table width="100%">
											<tr>
									...
									<form name="form-search" id="form-search_mobile" method="post" action="<?=site_url('web/search/maps_warnet')?>">
