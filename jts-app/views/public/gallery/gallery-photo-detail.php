							...
							<div class="row-fluid">	
								...
								<div class="span12 center" style="margin-bottom:10px">
									<a class="no-thumb img-preview span12" id="large-gallery" href="javascript:void(0)">
										<img id="img-gallery" src="<?=base_url($gallery['thumbnail']['image_path'] . $gallery['thumbnail']['image_name'])?>" alt="photo"/>
										<div id="img-description" class="image-description"><?=$gallery['thumbnail']['image_description']?></div>
									</a>
								</div>
								<div class="separator bottom"></div>
