								...
								<ul class="thumbnails">								
									...
									<li class="span6">
										...
										<div class="thumbnail widget-thumbnail">											
											<?php if($gallery['thumbnail']['image_name'] != ''):?>
											<a href="<?=site_url('web/gallery_detail/'.$tp.'/'.$gallery['gallery_id'].'/'.clean_url($gallery['gallery_title']))?>" title="Detail">
												<img src="<?=base_url($gallery['thumbnail']['image_path'] . $gallery['thumbnail']['image_name'])?>" alt="" />
											</a>
											<?php endif;?>
											<div class="caption">
												...
												<p align="justify"><?=slice_text($gallery['gallery_description'], 200)?> ...</p>
