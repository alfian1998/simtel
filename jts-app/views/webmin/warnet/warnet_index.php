						...
						<div class="widget-body">
							<div class="row-fluid">	
								<div class="span12">
									...
									<table width="100%">
									<tr>
										<td width="10%"><a href="<?=site_url('webmin_warnet/form')?>" class="btn btn-primary btn-mini" style="padding:3px 15px 3px 15px; margin-bottom:10px"><b><i class="fa fa-plus"></i> Tambah Data</b></a></td>
										<td width="7%">
