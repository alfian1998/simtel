						...
						<div class="widget-body">
							<div class="row-fluid">	
								<div class="span12">
									...
									<table width="100%">
									<tr>
										<td width="10%"><a href="<?=site_url('webmin_extension/form')?>" class="btn btn-secondary btn-mini" style="padding:3px 15px 3px 15px; margin-bottom:10px"><b>+ TAMBAH DATA</b></a></td>
										<td width="8%">
