...
$(function() {
    ...
    function ses_kelurahan_id(i,k) {
        $.get('<?=site_url("webmin_jml_sinyal/ajax/ses_kelurahan_id")?>?ses_kecamatan_id='+i+'&ses_kelurahan_id='+k,null,function(data) {
    ...
    $('#proses').bind('click',function() {
        ...
        if(uptd_id.val() == '') {
            ...
            $('#mainform').attr('action','<?=site_url("webmin_jml_sinyal/filter/jml_sinyal")?>').submit();
        }        
    });
    //
    $('.row_dim').hide(); 
