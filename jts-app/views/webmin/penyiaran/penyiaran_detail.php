				...
				<div class="span12">
					...
					<div class="widget widget-heading-simple widget-body-white">
					    ...
					    <!-- <ol class="breadcrumb breadcrumb-arrow">
							...
							<li><a href="<?=site_url('webmin_penyiaran')?>">Penyiaran</a></li>
							<li class="active"><span><b>Detail Penyiaran</b></span></li>
						</ol> -->
						<ul class="breadcrumb">
							...
							<li>Detail Penyiaran Radio & Telvisi</li>
						</ul>
						<!-- //Breadcrumb -->
							...
							<div class="row-fluid">	
								<div class="span12">
									        ...
									        <tr valign="top">
									            <td width="462px">
									            	<table>		
														...
														<tr>
															<td width="150px"><div class="span12"><b>Nama Radio</b></div></td>
															<td width="300px"><div class="span12"> : <?=$main['radio_nm']?></div></td>
														</tr>
														<tr>
															<td width="150px"><div class="span12"><b>Jalan Dan Nomor</b></div></td>
															<td width="300px"><div class="span12"> : <?=$main['alamat_jl']?></div></td>
														</tr>
														<tr>
														...
														<tr>
															...
															<td width="300px"><div class="span12"> : <?=$main['alamat_kecamatan']?></div></td>
														</tr>
														<tr>
															<td width="150px"><div class="span12"><b>Desa/Kelurahan</b></div></td>
															<td width="300px"><div class="span12"> : <?=$main['alamat_desa']?></div></td>
														</tr>
														<tr>
															<td width="150px"><div class="span12"><b>Kabupaten</b></div></td>
														...
														<tr>
															<td width="150px"><div class="span12"><b>No Telepon Kantor</b></div></td>
															<td width="300px"><div class="span12"> : <?=$main['no_telp']?></div></td>
														</tr>
														<tr>
															<td width="150px"><div class="span12"><b>Website</b></div></td>
															<td width="300px"><div class="span12"> : <?=$main['website']?></div></td>
														</tr>
														<tr>
															<td width="150px"><div class="span12"><b>Email</b></div></td>
															<td width="300px"><div class="span12"> : <?=$main['email']?></div></td>
														</tr>
														<tr>
															<td width="150px"><div class="span12"><b>Facebook</b></div></td>
															<td width="300px"><div class="span12"> : <?=$main['facebook']?></div></td>
														</tr>
														<tr>
															<td width="150px"><div class="span12"><b>Twitter</b></div></td>
															<td width="300px"><div class="span12"> : <?=$main['twitter']?></div></td>
														</tr>
														<tr>
															<td width="150px"><div class="span12"><b>Alamat Internet Lainya</b></div></td>
															<td width="300px"><div class="span12"> : <?=$main['alamat_internet_lain']?></div></td>
														</tr>
														<tr>
															<td width="150px"><div class="span12"><b>Dokumen Izin Penyelenggaraan Penyiaran</b></div></td>
															<td width="300px"><div class="span12"> : <?=$main['dokumen_perijinan_nm']?></div></td>
														</tr>
														<tr>
															<td width="150px"><div class="span12"><b>Sertifikat Peralatan Pemancar</b></div></td>
															<td width="300px"><div class="span12"> : <?=$main['sertifikat_pemancar_nm']?></div></td>
														</tr>
														<tr>
															<td width="150px"><div class="span12"><b>Struktur Organisasi (Jabatan Dan Nama)</b></div></td>
															<td width="300px"><div class="span12"> : <?=$main['struktur_organisasi_nm']?></div></td>
														</tr>
														<tr>
															<td width="150px"><div class="span12"><b>Mekanisme Penanganan Pengaduan</b></div></td>
															<td width="300px"><div class="span12"> : <?=$main['mekanisme_pengaduan_nm']?></div></td>
														</tr>
														<tr>
															<td width="150px"><div class="span12"><b>Pola/Format/Waktu Siaran (1 Minggu)</b></div></td>
															<td width="300px"><div class="span12"> : <?=$main['pola_siaran_nm']?></div></td>
														</tr>
														<tr>
															<td width="150px"><div class="span12"><b>Frekwensi</b></div></td>
															<td width="300px"><div class="span12"> : <?=$main['frekwensi']?></div></td>
														</tr>
														<tr>
															<td width="150px"><div class="span12"><b>Jangkauan</b></div></td>
															<td width="300px"><div class="span12"> : <?=$main['jangkauan']?>&nbsp; (meter)</div></td>
														</tr>
														<tr>
															<td width="150px"><div class="span12"><b>Waktu Siar</b></div></td>
															<td width="300px"><div class="span12"> : <?=$main['waktu_siar_mulai']?> s/d <?=$main['waktu_siar_selesai']?> WIB</div></td>
														</tr>
														<tr>
                                                            <td colspan="2">
                                                        ...
                                                        ?>
                                                        <tr>
															<td width="150px"><div class="span12"><b><?=$data['parameter_nm']?></b></div></td>
															<td width="300px"><div class="span12"> : <?=@$is_data['statusdata_nm']?></div></td>
														</tr>
														<tr>
															<td width="150px"><div class="span12"><b>Keterangan</b></div></td>
															<td width="300px"><div class="span12"> : <?=@$is_data['keterangan_segmentasi']?></div></td>
														</tr>
														<?php endforeach; ?>
													</table>
									            </td>
            									<td width="462px"> 
            										<table>		
														...
														<tr>
															<td width="150px"><div class="span12"><b>Keterangan</b></div></td>
															<td width="300px"><div class="span12"> : <?=@$is_data['keterangan_bahasa']?></div></td>
														</tr>
														<?php endforeach; ?>
														<tr>
                                                            <td colspan="2">
														...
														<tr>
															<td width="150px"><div class="span12"><b>Keterangan</b></div></td>
															<td width="300px"><div class="span12"> : <?=@$is_data['keterangan_konten']?></div></td>
														</tr>
														<?php endforeach; ?>
													</table>
            									</td>
										...
										<div class="right" style="margin-top:10px">
											<a href="<?=site_url('webmin/location/penyiaran')?>" class="btn btn-secondary btn-icon"> Kembali</a>
										</div>
								</div>
							</div>
						</div>
