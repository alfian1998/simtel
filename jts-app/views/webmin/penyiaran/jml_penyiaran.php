...
$(function() {
    ...
    function ses_kelurahan_id(i,k) {
        $.get('<?=site_url("webmin_jml_penyiaran/ajax/ses_kelurahan_id")?>?ses_kecamatan_id='+i+'&ses_kelurahan_id='+k,null,function(data) {
    ...
    $('#proses').bind('click',function() {
        ...
        if(uptd_id.val() == '') {
            ...
            $('#mainform').attr('action','<?=site_url("webmin_jml_penyiaran/filter/jml_penyiaran")?>').submit();
        }        
    });
    //
    $('.row_dim').hide(); 
			...
			<div class="row-fluid">
				<div class="span12">
					...
					<div class="widget widget-heading-simple widget-body-white">
						<div class="widget-head"><h4 class="heading glyphicons list"><i></i>Resume Jumlah Data Penyiaran Konten Siaran Radio Televisi</h4></div>
									...
									<form name="mainform" id="mainform" class="row-fluid margin-none" action="" method="post" enctype="multipart/form-data">	
										...
										<div class="right" style="margin-top:10px">
											...
											<?php if($filter_search == 'true'):?>
												<a href="<?=site_url('webmin_jml_penyiaran/search');?>" class="btn btn-success btn-icon btn-submit"><i></i> Export Excel</a>
											<?php endif; ?>
											<a href="<?=site_url('webmin_jml_penyiaran/location/jml_penyiaran')?>" class="btn btn-danger btn-icon btn-submit"><i></i> Clear</a>
										</div>
										...
										<br>
											<?php if($ses_jenis_laporan == '1'): ?>
												<div class="alert alert-success">
													<strong>Resume Jumlah Penyiaran Per Kecamatan</strong>
												</div>
													...
													<div class="span6">
														...
														<table style="width: 100%!important" class="table table-bordered table-primary table-striped table-vertical-center checkboxs js-table-sortable">
															...
															<tr>
																...
																<th class="center" width="30%">Radio/TV</th>
															</tr>
														    </thead>
														    <tbody>
														    	<?php 
																...
																<tr>
																	...
																	<td class="center">
																		<?php foreach ($data['radio_nm'] as $penyiaran):
																		?>
																		<?=$penyiaran['radio_nm']?>,
																		<?php endforeach; ?>
																	</td>
											...
											<?php elseif($ses_jenis_laporan == '2'): ?>
												<div class="alert alert-success">
													<?php 
													if($ses_kecamatan_id != ''):
													$nama_kecamatan = $this->penyiaran_model->get_wilayah_by_id($ses_kecamatan_id);
													?>
														<strong>Resume Jumlah Penyiaran Dari Kecamatan : <?=$nama_kecamatan['wilayah_nm']?></strong>
													<?php else: ?>
														<strong>Resume Jumlah Penyiaran Per Kelurahan</strong>
													<?php endif; ?>
												</div>
												<div class="table-responsive">
													<div class="span6">
														...
														<table style="width: 100%!important" class="table table-bordered table-primary table-striped table-vertical-center checkboxs js-table-sortable">
															...
															<tr>
																<th class="center" width="2%">No</th>
																<th class="center" width="25%" colspan="2">Kecamatab & Kelurahan</th>
																<th class="center" width="17%">Jumlah</th>
																<th class="center" width="30%">Radio/TV</th>
															</tr>
														    </thead>
														    <tbody>
																...
																<tr>
																	...
																	<tr>
																		...
																		<td class="center">
																			<?php foreach ($kel['radio_nm'] as $penyiaran):
																			?>
																				<?=$penyiaran['radio_nm']?>,
																			<?php endforeach; ?>
																		</td>
													...
													<div class="span6">
														...
														<?php else: ?>
															<div id="kelurahan" style="height: 18718px; "></div>
														<?php endif; ?>
													</div>
												</div>
											<?php endif; ?>
