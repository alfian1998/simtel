				...
				<div class="span12">
					...
					<div class="widget widget-heading-simple widget-body-white">
					    ...
					    <ul class="breadcrumb">
							...
							<li>Detail Jaringan Telepon/RIG</li>
						</ul>
						<!-- //Breadcrumb -->
							...
							<div class="row-fluid">	
								<div class="span12">
									        ...
									        <tr valign="top">
									            <td width="462px">
									            	<table>	
														...
														<tr>
															<td width="150px"><div class="span12"><b>Tahun Anggaran</b></div></td>
															<td width="300px"><div class="span12"> : <?=$main['thn_anggaran']?></div></td>
														</tr>
													</table>
									            </td>
            									<td width="462px"> 
            										<table>		
														...
														<tr>
															...
															<td width="300px"><div class="span12"> : <?=@$get_opd['skpd_nm']?></div></td>
														</tr>
														<tr>
															<td width="150px"><div class="span12"><b>Tanggal Pelaporan</b></div></td>
															<td width="300px"><div class="span12"> : <?=$main['tgl_pelaporan']?></div></td>
														</tr>
														<tr>
															<td width="150px"><div class="span12"><b>Jenis Tindakan</b></div></td>
															<td width="300px"><div class="span12"> : <?=$main['jenistindakan_nm']?></div></td>
														</tr>
														<?php foreach ($list_jenis_tindakan as $data): ?>
															<?php if($data['is_selected'] == 'true'): ?>
																<tr>
																	<td width="150px"><div class="span12"><b>No. Inventaris Barang <?=$data['parameter_nm']?></b></div></td>
																	<td width="300px"><div class="span12"> : <?=split_value_by_reff(@$main['no_inventaris'],@$main['jenistindakan_id'],$data['parameter_id'])?></div></td>
																</tr>
															<?php endif; ?>
														<?php endforeach; ?>
													</table>
										...
										<div class="right" style="margin-top:10px">
											<a href="<?=site_url('webmin/location/telepon')?>" class="btn btn-secondary btn-icon"> Kembali</a>
										</div>
								</div>
							</div>
						</div>
