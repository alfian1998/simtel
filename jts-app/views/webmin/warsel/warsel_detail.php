				...
				<div class="span12">
					...
					<div class="widget widget-heading-simple widget-body-white">
					    ...
					    <!-- <ol class="breadcrumb breadcrumb-arrow">
							...
							<li class="active"><span><b>Detail Warsel</b></span></li>
						</ol> -->
						<ul class="breadcrumb">
							...
							<div class="row-fluid">	
								<div class="span12">
									        ...
									        <tr valign="top">
									            <td width="462px">
									            	<table>		
														...
														<tr>
															<td width="150px"><div class="span12"><b>Nama Warsel</b></div></td>
															<td width="300px"><div class="span12"> : <?=$main['warsel_nm']?></div></td>
														</tr>
														<tr>
															<td width="150px"><div class="span12"><b>Alamat</b></div></td>
															<td width="300px"><div class="span12"> : <?=$main['warsel_alamat']?></div></td>
														</tr>
														<tr>
															<td width="150px"><div class="span12"><b>Kecamatan</b></div></td>
															<td width="300px"><div class="span12"> : <?=$main['warsel_alamat_kecamatan']?></div></td>
														</tr>
														<tr>
															<td width="150px"><div class="span12"><b>Desa/Kelurahan</b></div></td>
															<td width="300px"><div class="span12"> : <?=$main['warsel_alamat_desa']?></div></td>
														</tr>
														<tr>
															<td width="150px"><div class="span12"><b>Kode Pos</b></div></td>
															<td width="300px"><div class="span12"> : <?=$main['warsel_alamat_kode_pos']?></div></td>
														</tr>
														<tr>
															<td width="150px"><div class="span12"><b>Telepon</b></div></td>
															<td width="300px"><div class="span12"> : <?=$main['warsel_telepon']?></div></td>
														</tr>
														<tr>
            									...
            									<td width="462px"> 
            										<table>		
														...
														<tr>
															<td width="150px"><div class="span12"><b>Surat Ijin Usaha</b></div></td>
															<td width="300px"><div class="span12"> : <?=$main['ijinusaha_nm']?></div></td>
														</tr>
														<tr>
															<td width="150px"><div class="span12"><b>Tahun Mulai Operasi</b></div></td>
															<td width="300px"><div class="span12"> : <?=$main['thn_mulai_opr']?></div></td>
														</tr>
														<tr>
															<td colspan="2">
										...
										<div class="right" style="margin-top:10px">
											<a href="<?=site_url('webmin/location/warsel')?>" class="btn btn-secondary btn-icon"> Kembali</a>
										</div>
								</div>
							</div>
						</div>
