...
class Webmin_Report_Sinyal extends CI_Controller{
	...
	function index($p=1, $o=0) {	
		...
		//
		$data['form_action'] = site_url('webmin_report_sinyal/filter');
		//
		$data['p'] = $p;
		$data['o'] = $o;
		...
		$data['list_sinyal'] = $this->sinyal_model->list_export_sinyal();
		endif;
		//
		...
		$this->load->view('webmin/sinyal/sinyal_export_excel',$data);
	...
	function search() {
		...
		$data['filter_search'] = @$_SESSION['filter_search'];
		//
		$this->sinyal_model->export_excel();
	}
