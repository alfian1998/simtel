...
class Webmin_Jml_Penyiaran extends CI_Controller{
	...
	function index($p=1, $o=0) {	
		...
		$this->load->view('webmin/penyiaran/jml_penyiaran',$data);
	...
	function search() {
		...
		if ($data['ses_jenis_laporan'] == '1') {
			$this->penyiaran_model->export_excel_jumlah_per_kecamatan();
		}elseif($data['ses_jenis_laporan'] == '2'){
			$this->penyiaran_model->export_excel_jumlah_per_kelurahan();
		}
	}
