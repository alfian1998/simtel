...
class Webmin_Report_Menara extends CI_Controller{
	...
	function index($p=1, $o=0) {	
		...
		//
		$data['form_action'] = site_url('webmin_report_menara/filter');
		//
		$data['p'] = $p;
		$data['o'] = $o;
		...
		$data['list_menara'] = $this->menara_model->list_export_menara();
		endif;
		//
		...
		$this->load->view('webmin/menara/menara_export_excel',$data);
	...
	function search() {
		...
		$data['filter_search'] = @$_SESSION['filter_search'];
		//
		$this->menara_model->export_excel();
	}
