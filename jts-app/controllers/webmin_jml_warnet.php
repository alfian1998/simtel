...
class Webmin_Jml_Warnet extends CI_Controller{
	...
	function index($p=1, $o=0) {	
		...
		$this->load->view('webmin/warnet/jml_warnet',$data);
	...
	function search() {
		...
		if ($data['ses_jenis_laporan'] == '1') {
			$this->warnet_model->export_excel_jumlah_per_kecamatan();
		}elseif($data['ses_jenis_laporan'] == '2'){
			$this->warnet_model->export_excel_jumlah_per_kelurahan();
		}
	}
