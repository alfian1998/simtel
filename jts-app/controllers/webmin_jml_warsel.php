...
class Webmin_Jml_Warsel extends CI_Controller{
	...
	function index($p=1, $o=0) {	
		...
		$this->load->view('webmin/warsel/jml_warsel',$data);
	...
	function search() {
		...
		if ($data['ses_jenis_laporan'] == '1') {
			$this->warsel_model->export_excel_jumlah_per_kecamatan();
		}elseif($data['ses_jenis_laporan'] == '2'){
			$this->warsel_model->export_excel_jumlah_per_kelurahan();
		}
	}
